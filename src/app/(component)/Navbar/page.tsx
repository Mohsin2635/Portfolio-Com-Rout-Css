      ...
      {isSidebarOpen && (
        <div className={styles.second_panal}>
          <ul className={styles.second_panal_ul}>
            ...
            <li>
              <Link href="/" className={styles.second_panal_li}>
                Home
              </Link>
            </li>
            <li>
              <Link href="/About" className={styles.second_panal_li}>
                About
              </Link>
            </li>
            <li>
              <Link href="/Services" className={styles.second_panal_li}>
                Services
              </Link>
            </li>
            <li>
              <Link href="/Projects" className={styles.second_panal_li}>
                Projects
              </Link>
            </li>
            <li>
              <Link href="/Contact" className={styles.second_panal_li}>
                Contact
              </Link>
            </li>
          </ul>
